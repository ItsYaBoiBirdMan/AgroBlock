...
public class DecisionTreeClient : MonoBehaviour
{
    ...
    [SerializeField]
    private float[] features = { 72.0f, 25.0f, 16.0f, 8.0f }; // Replace with actual input features
    ...
    {
        // Create a dictionary to store the JSON payload
        ...
        string jsonPayload = JsonUtility.ToJson(new Wrapper(payload));
